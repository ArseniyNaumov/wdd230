...
const apiUrl = `https://api.openweathermap.org/data/2.5/onecall?lat=20.42&lon=-86.92&exclude=minutely,hourly,daily&appid=${apiKey}&units=imperial`;

fetch(apiUrl)
    .then(response => response.json())
    .then(data => {
        const forecast = data.current.temp;
